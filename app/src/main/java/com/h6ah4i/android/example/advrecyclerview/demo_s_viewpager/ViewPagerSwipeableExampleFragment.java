...
public class ViewPagerSwipeableExampleFragment extends Fragment {
    ...
    public static ViewPagerSwipeableExampleFragment newInstance(String dataProvider, boolean canSwipeLeft) {
        ViewPagerSwipeableExampleFragment fragment = new ViewPagerSwipeableExampleFragment();
    ...
    public ViewPagerSwipeableExampleFragment() {
        super();
    }
