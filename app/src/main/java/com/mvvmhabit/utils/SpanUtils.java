package com.mvvmhabit.utils;//package com.elongtian.etshop.utils;
//
...
//
///**
// * 作者：Administrator on 2017/11/16 15:35
// * 邮箱：android_gaoxuge@163.com
// * SpannableString相关工具类
// * 用法参考 https://github.com/Blankj/AndroidUtilCode/blob/master/app/src/main/java/com/blankj/androidutilcode/core/span/SpanActivity.java
// */
...
//            try {
//                return MediaStore.Images.Media.getBitmap(BaseApplication.getmInstance().getContentResolver(), uri);
//            } catch (IOException e) {
//                e.printStackTrace();
...
//            Drawable drawable = ContextCompat.getDrawable(BaseApplication.getmInstance(), resourceId);
...
//            mDrawable = new BitmapDrawable(BaseApplication.getmInstance().getResources(), b);
...
//                Bitmap bitmap;
//                try {
//                    InputStream is = BaseApplication.getmInstance().getContentResolver().openInputStream(mContentUri);
//                    bitmap = BitmapFactory.decodeStream(is);
//                    drawable = new BitmapDrawable(BaseApplication.getmInstance().getResources(), bitmap);
//                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
//                    if (is != null) {
//                        is.close();
//                    }
...
//            } else {
//                try {
//                    drawable = ContextCompat.getDrawable(BaseApplication.getmInstance(), mResourceId);
//                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
//                } catch (Exception e) {
