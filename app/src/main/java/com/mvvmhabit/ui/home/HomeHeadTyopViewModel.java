...
public class HomeHeadTyopViewModel extends BaseViewModel {
    public ObservableField<HomeHeadEntity.CategoryAd> observableField = new ObservableField<>();
    public Drawable drawable;


    public HomeHeadTyopViewModel(@NonNull Application application, HomeHeadEntity.CategoryAd categoryAd) {
        super(application);
