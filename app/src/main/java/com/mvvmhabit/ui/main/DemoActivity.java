...
import com.example.swipetestdemo.databinding.ActivityDemoBinding;
...
public class DemoActivity extends BaseActivity<ActivityDemoBinding, DemoViewModel> {
    ...
    public void initData() {
        Messenger.getDefault().register(this, Contans.HOME_DEMO,String.class, new BindingConsumer<String>() {
            @Override
            public void call(String product) {
                KLog.e("sss   "+product);
                binding.btnLiebiao.setText(product);
            }
        });
    }
    ...
    private void requestCameraPermissions() {
        ...
        rxPermissions.request(Manifest.permission.CALL_PHONE).subscribe(new Consumer<Boolean>() {
            ...
            public void accept(Boolean aBoolean) throws Exception {
                if (aBoolean) {
                            ToastUtils.showShort("电话权限已经打开，直接跳入拨号");
                        } else {
