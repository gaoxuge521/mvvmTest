package com.mvvmhabit.ui.main;

import android.app.Application;
import android.os.Bundle;

import com.mvvmhabit.entity.FormEntity;
import com.mvvmhabit.jiemai.MainActivity;
import com.mvvmhabit.ui.form.FormFragment;
import com.mvvmhabit.ui.home.HomeActivity;
import com.mvvmhabit.ui.network.NetWorkFragment;
import com.mvvmhabit.ui.networklist.NetWorkListFragment;
import com.mvvmhabit.ui.register.RegisterActivity;
import com.mvvmhabit.ui.rv_multi.MultiRecycleViewFragment;
import com.mvvmhabit.ui.tab_bar.activity.TabBarActivity;
import com.mvvmhabit.ui.viewpager.activity.ViewPagerActivity;
import com.mvvmhabit.ui.vp_frg.ViewPagerGroupFragment;
...
public class DemoViewModel extends BaseViewModel {
    ...
    //首页
    public BindingCommand homeViewClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
    ...
    //列表请求
    public BindingCommand netWrokListClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
            startContainerActivity(NetWorkListFragment.class.getCanonicalName());
        }
    });
    //列表请求
    public BindingCommand jieMaiViewClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
