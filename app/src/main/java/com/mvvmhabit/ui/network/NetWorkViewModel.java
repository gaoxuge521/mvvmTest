package com.mvvmhabit.ui.network;
...
public class NetWorkViewModel extends BaseViewModel<DemoRepository> {
    ...
    public ItemBinding<NetWorkItemViewModel> itemBinding = ItemBinding.of(com.example.swipetestdemo.BR.viewModel, R.layout.item_network);
    //下拉刷新
