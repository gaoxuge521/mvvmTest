package com.mvvmhabit.ui.rv_multi;
    ...
    public ItemBinding<MultiItemViewModel> itemBinding = ItemBinding.of(new OnItemBind<MultiItemViewModel>() {
        ...
        public void onItemBind(ItemBinding itemBinding, int position, MultiItemViewModel item) {
            ...
            if (MultiRecycleType_Head.equals(itemType)) {
                //设置头布局
                itemBinding.set(com.example.swipetestdemo.BR.viewModel, R.layout.item_multi_head);
            } else if (MultiRecycleType_Left.equals(itemType)) {
                //设置左布局
                itemBinding.set(com.example.swipetestdemo.BR.viewModel, R.layout.item_multi_rv_left);
            } else if (MultiRecycleType_Right.equals(itemType)) {
                //设置右布局
                itemBinding.set(com.example.swipetestdemo.BR.viewModel, R.layout.item_multi_rv_right);
            }
        }
    });
}
