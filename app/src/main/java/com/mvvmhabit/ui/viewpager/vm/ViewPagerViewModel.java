package com.mvvmhabit.ui.viewpager.vm;
...
public class ViewPagerViewModel extends BaseViewModel {
    ...
    public ItemBinding<ViewPagerItemViewModel> itemBinding = ItemBinding.of(com.example.swipetestdemo.BR.viewModel, R.layout.item_viewpager);
