package com.mvvmhabit.ui.base.viewmodel;
...
public class ToolbarViewModel<M extends BaseModel> extends BaseViewModel<M> {
    ...
    //左边的返回按钮观察者
    public ObservableInt leftBackIvVisibleObservable = new ObservableInt(View.VISIBLE);
    //右边图标的观察者
    ...
    public void setLeftIconVisible(int visibility) {
        leftBackIvVisibleObservable.set(visibility);
    }
